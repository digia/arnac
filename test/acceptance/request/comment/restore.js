...
describe('Request Comment - Restore', function () {
  ...
  describe('POST /request/{requestId}/comment/{id}/restore', function () {
    ...
    it(`401 if client is not authorized`, function (done) {
      ...
      const options = {
        method: 'POST',
        url: `/request/${mRequestListData.estimate.id}/comment/${mRequestCommentListData.deleted.id}/restore`,
      };
    ...
    it(`200 if succesfully restores the request comment`, function (done) {
    ...
    it(`404 if request is deleted`, function (done) {
      ...
      const options = {
        method: 'POST',
        url: `/request/${mRequestListData.deleted.id}/comment/${mRequestCommentListData.availableOnDeletedRequest.id}/restore`,
        headers: generateAuthHeaders(authToken),
      };
    ...
    it(`404 if request doesn't exist`, function (done) {
      ...
      const options = {
        method: 'POST',
        url: `/request/${_id}/comment/${_id}/restore`,
        headers: generateAuthHeaders(authToken),
      };
    ...
    it(`404 if request comment doesn't exist`, function (done) {
      ...
      const options = {
        method: 'POST',
        url: `/request/${mRequestListData.deleted.id}/comment/${_id}/restore`,
        headers: generateAuthHeaders(authToken),
      };
    ...
    it(`409 for bad state if attempting to restore a request comment which isn't deleted`, function (done) {

      const options = {
        method: 'POST',
        url: `/request/${mRequestListData.estimate.id}/comment/${mRequestCommentListData.available.id}/restore`,
        headers: generateAuthHeaders(authToken),
      };
